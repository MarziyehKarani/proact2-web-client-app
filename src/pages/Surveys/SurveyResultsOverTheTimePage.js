...
} from "../../infrastructure/services/network/apiCalls/dataExportersApiServece"
    ...
    <Container>
...

      {
        statistics ? (
          !statisticsAreEmpty ? (
            <>
              <SurveyHeaderCard props={props} survey={statistics} />
              ...
              {statistics.questions.map((element, idx) => (
                <Card key={idx}>
                  <CardBody>
                    ...
                    <SurveyStatsOverTheTimeChart
                      props={props}
                      questionStats={element}
                    />
                  </CardBody>
                </Card>
              ))}
              {(statistics.footer || statistics.footerImage) && (
                <SurveyFooterCard props={props} survey={statistics} />
              )}
            </>
          ) : (
            <Card>
